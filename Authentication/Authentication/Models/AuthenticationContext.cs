...
public partial class AuthenticationContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Category__3214EC07A3D3F4A3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Order__3214EC07BF11BE09");
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.OrderEmployees)
                ...
                .HasConstraintName("FK__Order__EmployeeI__2E1BDC42");
        });

        modelBuilder.Entity<OrderDetail>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderDet__3214EC07501FA082");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Product__3214EC074E82921C");
